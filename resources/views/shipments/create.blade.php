                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="recipient_address" class="form-control @error('recipient_address') is-invalid @enderror" 
                                          rows="2" required>{{ old('recipient_address') }}</textarea>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="size" class="form-select @error('size') is-invalid @enderror" required>
                                    @foreach(\App\Models\Shipment::SIZE_LABELS as $key => $label)
                                        <option value="{{ $key }}" {{ old('size', 'M') == $key ? 'selected' : '' }}>
                                            {{ $label }} ({{ $key }})
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="weight" class="form-control @error('weight') is-invalid @enderror" 
                                       value="{{ old('weight') }}" step="0.1" min="0">
                                @error('weight')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4">
                                ...
                                <input type="datetime-local" name="preferred_delivery_at" 
                                       ...
                                       value="{{ old('preferred_delivery_at') }}">
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="bi bi-check-lg me-2"></i>発送を登録
                    </button>
